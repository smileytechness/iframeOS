                        ...
                        <div className="max-w-3xl mx-auto p-4">
                            <div className="flex items-center min-w-0 space-x-2">
                                <input
                                    ...
                                    className="flex-1 min-w-0 p-2 border border-gray-300 dark:border-gray-600 
                                             rounded-lg bg-white dark:bg-gray-800"
                                />
                                <button
                                    onClick={handleSendMessage}
                                    className="flex-none px-4 py-2 bg-primary text-white rounded-lg 
                                             hover:bg-primary-dark whitespace-nowrap"
                                >
                                    Send
                                </button>
                            </div>
